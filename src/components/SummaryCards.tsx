    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      {showFiltered && (
        <div className="bg-blue-50 rounded-xl border border-blue-200 p-5 shadow-sm">
          ...
          <p className="text-xs text-blue-600 mt-1">{filteredItems} items</p>
        </div>
      )}
    </div>
  );
